    ...
    class ClassNames {
        ...
        normalizeClassName_(className) {
            ...
            for (let index = 0; index < className.length; index++) {
                const name = TheDatepicker.Helper_.checkString_(parameterName, className[index]);
                if (name) {
                    result.push(name);
                }
            }
...
(function (TheDatepicker) {
    ...
    class Datepicker {
            ...
            switch (this.initializationPhase_) {
                ...
                case InitializationPhase.Untouched:
                    ...
                    if (this.inputClickable_ && this.options.isHiddenOnBlur()) {
                        ...
                        this.inputListenerRemover_ = TheDatepicker.Helper_.addEventListener_(this.inputClickable_, TheDatepicker.ListenerType_.Focus, (event) => {
                            this.open(event);
                        });
        ...
        createDeselectElement_() {
            ...
            const deselectButton = TheDatepicker.HtmlHelper_.createAnchor_((event) => {
            ...
            const deselectElement = TheDatepicker.HtmlHelper_.createSpan_();
        ...
        initListeners_() {
            if (!Datepicker.areGlobalListenersInitialized_) {
                ...
                TheDatepicker.Helper_.addEventListener_(Datepicker.document_, TheDatepicker.ListenerType_.KeyDown, (event) => {
            ...
            if (this.inputClickable_) {
                ...
                this.listenerRemovers_.push(TheDatepicker.Helper_.addEventListener_(this.inputClickable_, TheDatepicker.ListenerType_.Blur, () => {
                    this.updateInput_();
                }));
            }
            if (this.inputText_) {
                this.listenerRemovers_.push(TheDatepicker.Helper_.addEventListener_(this.inputText_, TheDatepicker.ListenerType_.KeyDown, (event) => {
                    TheDatepicker.Helper_.stopPropagation_(event);
                    if (event.keyCode === TheDatepicker.KeyCode_.Esc && this.options.isClosedOnEscPress()) {
                        this.close(event);
                    }
                }));
                this.listenerRemovers_.push(TheDatepicker.Helper_.addEventListener_(this.inputText_, TheDatepicker.ListenerType_.KeyUp, (event) => {
                    this.readInput_(event);
                }));
                this.listenerRemovers_.push(TheDatepicker.Helper_.addEventListener_(this.inputText_, TheDatepicker.ListenerType_.KeyPress, (event) => {
        ...
        updateContainer_() {
            ...
            let locateOver = position === TheDatepicker.Position.TopRight || position === TheDatepicker.Position.TopLeft;
            let locateLeft = position === TheDatepicker.Position.BottomLeft || position === TheDatepicker.Position.TopLeft;
...
(function (TheDatepicker) {
    ...
    class Helper_ {
        ...
        static getWeekNumber_(date, firstDayOfWeek) {
...
(function (TheDatepicker) {
    class HtmlHelper_ {
        ...
        static createAnchor_(onClick, options, type = TheDatepicker.ClassNameType.Button) {
...
(function (TheDatepicker) {
    ...
    class Template_ {
        ...
        createSkeleton_(viewModel) {
            const main = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.Main, this.options_);
        ...
        createBodyElement_(viewModel) {
            const body = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.Body, this.options_);
            const tables = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.Tables, this.options_);
            ...
            if (this.options_.isMonthChangeOnSwipeEnabled() || this.options_.isTableOfYearsOnSwipeDownEnabled()) {
                ...
                TheDatepicker.Helper_.addSwipeListener_(body, (event, moveDirection) => {
                    let isForward = false;
                    let change = null;
        ...
        createHeaderElement_(viewModel) {
            const header = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.Header, this.options_);
            const top = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.HeaderTop, this.options_);
            header.appendChild(top);
            top.appendChild(this.createTitleElement_(viewModel));
            const control = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.HeaderControl, this.options_);
            top.appendChild(control);
            control.appendChild(this.createResetElement_(viewModel));
            control.appendChild(this.createCloseElement_(viewModel));
            const navigation = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.HeaderNavigation, this.options_);
            header.appendChild(navigation);
            navigation.appendChild(this.createGoElement_(viewModel, false));
            const state = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.HeaderState, this.options_);
        ...
        createTitleElement_(viewModel) {
            const titleElement = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.HeaderTitle, this.options_);
            const titleContent = TheDatepicker.HtmlHelper_.createSpan_();
        ...
        createResetElement_(viewModel) {
            const resetElement = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.Reset, this.options_);
            const resetButton = TheDatepicker.HtmlHelper_.createAnchor_((event) => {
        ...
        createCloseElement_(viewModel) {
            const closeElement = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.Close, this.options_);
            const closeButton = TheDatepicker.HtmlHelper_.createAnchor_((event) => {
        ...
        createGoElement_(viewModel, isForward) {
            const goElement = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.Go, this.options_);
            ...
            const goButton = TheDatepicker.HtmlHelper_.createAnchor_((event) => {
                const moveDirection = isForward ? TheDatepicker.MoveDirection_.Left : TheDatepicker.MoveDirection_.Right;
        ...
        createMonthElement_(viewModel) {
            ...
            const selectElement = TheDatepicker.HtmlHelper_.createSelectInput_(options, (event, monthNumber) => {
            ...
            const monthElement = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.HeaderMonth, this.options_);
            const monthContent = TheDatepicker.HtmlHelper_.createSpan_();
        ...
        createYearElement_(viewModel) {
            const yearElement = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.HeaderYear, this.options_);
            let yearActiveElement;
            if (this.options_.isYearSelectedFromTableOfYears()) {
                yearActiveElement = TheDatepicker.HtmlHelper_.createAnchor_(() => {
                    this.slideTable_(viewModel, viewModel.yearSelectionState_ ? TheDatepicker.MoveDirection_.Up : TheDatepicker.MoveDirection_.Down, () => {
                ...
                yearActiveElement = TheDatepicker.HtmlHelper_.createSelectInput_([], (event, year) => {
                    const currentMonth = viewModel.getCurrentMonth_();
            ...
            const yearTextElement = TheDatepicker.HtmlHelper_.createSpan_();
        ...
        createMonthAndYearElement_(viewModel) {
            const monthAndYear = TheDatepicker.HtmlHelper_.createDiv_(TheDatepicker.ClassNameType.HeaderMonthYear, this.options_);
            const selectElement = TheDatepicker.HtmlHelper_.createSelectInput_([], (event, value) => {
                const currentMonth = viewModel.getCurrentMonth_();
                let newMonth = new Date(currentMonth.getTime());
            ...
            const monthAndYearContent = TheDatepicker.HtmlHelper_.createSpan_();
        ...
        createTableElement_(viewModel) {
            ...
            const table = TheDatepicker.HtmlHelper_.createTable_(tableHeader, tableBody, TheDatepicker.ClassNameType.CalendarTable, this.options_);
        ...
        createTableHeaderWeekNumberCellElement_() {
            const headerCell = TheDatepicker.HtmlHelper_.createTableHeaderCell_(TheDatepicker.ClassNameType.CalendarTableHeaderWeekNumber, this.options_);
            headerCell.innerText = this.options_.translator.translateWeekNumber();
            return headerCell;
        }
        createTableHeaderCellElement_(viewModel, dayOfWeek) {
            const headerCell = TheDatepicker.HtmlHelper_.createTableHeaderCell_(TheDatepicker.ClassNameType.CalendarTableHeaderCell, this.options_);
        ...
        createTableRowElement_(viewModel) {
            ...
            for (let index = 0; index < 7; index++) {
                const cell = TheDatepicker.HtmlHelper_.createTableCell_();
            ...
            if (this.options_.areWeekNumbersShown()) {
                const weekNumberCell = TheDatepicker.HtmlHelper_.createTableCell_();
                TheDatepicker.HtmlHelper_.addClass_(weekNumberCell, TheDatepicker.ClassNameType.WeekNumber, this.options_);
                this.weeksNumbersElements_.push(weekNumberCell);
                rowCells.unshift(weekNumberCell);
            }
            return TheDatepicker.HtmlHelper_.createTableRow_(rowCells, this.options_);
        }
        ...
        createTableCellButtonElement_(viewModel) {
            const cellButton = TheDatepicker.HtmlHelper_.createAnchor_((event) => {
        ...
        createTableOfYearsElement_(viewModel) {
            ...
            const table = TheDatepicker.HtmlHelper_.createTable_(null, tableBody, TheDatepicker.ClassNameType.YearsTable, this.options_);
            TheDatepicker.HtmlHelper_.addClass_(table, TheDatepicker.ClassNameType.Table, this.options_);
            return table;
        }
        ...
        createTableOfYearsCellButtonElement_(viewModel) {
            const cellButton = TheDatepicker.HtmlHelper_.createAnchor_((event) => {
                ...
                if (correctMonth.getFullYear() === newMonth.getFullYear()) {
                    ...
                    this.slideTable_(viewModel, TheDatepicker.MoveDirection_.Up, () => {
        ...
        createTableOfYearsCellContentElement_(viewModel) {
            const cellContent = TheDatepicker.HtmlHelper_.createSpan_();
            TheDatepicker.HtmlHelper_.addClass_(cellContent, TheDatepicker.ClassNameType.ButtonContent, this.options_);
        ...
        slideTable_(viewModel, moveDirection, onComplete) {
            ...
            const trigger = () => {
                ...
                const animate = (type) => {
                    TheDatepicker.HtmlHelper_.addClass_(this.tablesElement_, TheDatepicker.ClassNameType.Animated, this.options_);
                    TheDatepicker.HtmlHelper_.addClass_(this.tablesElement_, type, this.options_);
                };
                const onAfterSlide = () => {
                ...
                listenerRemover = TheDatepicker.Helper_.addEventListener_(this.tablesElement_, TheDatepicker.ListenerType_.AnimationEnd, () => {
...
(function (TheDatepicker) {
    ...
    class Translator {
        constructor() {
            ...
            this.weekNumberTranslation_ = 'Wk';
            this.titles_ = [
        ...
        setWeekNumberTranslation(translation) {
            this.weekNumberTranslation_ = TheDatepicker.Helper_.checkString_('Translation', translation);
        }
    ...
    class ViewModel_ {
        ...
        goToMonth_(event, month, doCancelHighlight = true) {
            ...
            if (this.selectedDate_ && this.options_.isSelectedDateBoundWithMonth()) {
                ...
                const date = this.options_.calculateNearestAvailableDate_(new Date(month.getFullYear(), month.getMonth(), Math.min(this.selectedDate_.getDate(), maxDate.getDate())), month, maxDate);
                if (date) {
        ...
        getYearsRows_() {
            ...
            for (let year = firstYear; year <= firstYear + this.yearSelectionState_.cellsCount; year++) {
                const yearCellData = new TheDatepicker.YearCellData_(year);
        ...
        createDay_(date) {
            ...
            const currentMonth = this.getCurrentMonth_();
            const day = new TheDatepicker.Day(date, (date) => {
                return this.createDay_(date);
            }, (date, format = null) => {
                return TheDatepicker.DateConverter_.formatDate_(date, this.options_, format);
            });
        ...
        triggerOnBeforeSelect_(event, day, previousDay) {
            return this.options_.triggerEvent_(TheDatepicker.EventType_.BeforeSelect, (listener) => {
                return listener.call(this.datepicker_, event, day, previousDay);
            });
        }
        triggerOnSelect_(event, day, previousDay) {
            this.options_.triggerEvent_(TheDatepicker.EventType_.Select, (listener) => {
                return listener.call(this.datepicker_, event, day, previousDay);
            });
        }
        triggerOnBeforeOpen_(event) {
            return this.options_.triggerEvent_(TheDatepicker.EventType_.BeforeOpen, (listener) => {
                return listener.call(this.datepicker_, event, true);
            });
        }
        triggerOnOpen_(event) {
            this.options_.triggerEvent_(TheDatepicker.EventType_.Open, (listener) => {
                return listener.call(this.datepicker_, event, true);
            });
        }
        triggerOnBeforeClose_(event) {
            return this.options_.triggerEvent_(TheDatepicker.EventType_.BeforeClose, (listener) => {
                return listener.call(this.datepicker_, event, false);
            });
        }
        triggerOnClose_(event) {
            this.options_.triggerEvent_(TheDatepicker.EventType_.Close, (listener) => {
                return listener.call(this.datepicker_, event, false);
            });
        }
        triggerOnBeforeMonthChange_(event, month, previousMonth) {
            return this.options_.triggerEvent_(TheDatepicker.EventType_.BeforeMonthChange, (listener) => {
                return listener.call(this.datepicker_, event, month, previousMonth);
            });
        }
        triggerOnMonthChange_(event, month, previousMonth) {
            this.options_.triggerEvent_(TheDatepicker.EventType_.MonthChange, (listener) => {
                return listener.call(this.datepicker_, event, month, previousMonth);
            });
        }
        triggerOnBeforeFocus_(event, day, previousDay) {
            return this.options_.triggerEvent_(TheDatepicker.EventType_.BeforeFocus, (listener) => {
                return listener.call(this.datepicker_, event, day, previousDay);
            });
        }
        triggerOnFocus_(event, day, previousDay) {
            this.options_.triggerEvent_(TheDatepicker.EventType_.Focus, (listener) => {
                return listener.call(this.datepicker_, event, day, previousDay);
            });
        }
