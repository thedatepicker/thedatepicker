...
(function (TheDatepicker) {
    ...
    (function (InitializationPhase) {
        ...
        InitializationPhase[InitializationPhase["Initialized"] = 2] = "Initialized";
        InitializationPhase[InitializationPhase["Destroyed"] = 3] = "Destroyed";
    ...
    var Datepicker = (function () {
        ...
        Datepicker.prototype.updateElements_ = function () {
            if (this.initializationPhase_ === InitializationPhase.Destroyed) {
                return;
            }
            this.updateInput_();
...
(function (TheDatepicker) {
    ...
    var Helper_ = (function () {
        ...
        Helper_.animate_ = function (element, animationType, options, onBegin, onComplete) {
    ...
    var Template_ = (function () {
        ...
        Template_.prototype.updateMainElement_ = function (viewModel) {
            ...
            var update = function () {
                ...
                _this.mainElement_.className = '';
                TheDatepicker.HtmlHelper_.addClass_(_this.mainElement_, TheDatepicker.ClassNameType.Main, _this.options_);
                if (_this.options_.isDarkModeEnabled()) {
                    TheDatepicker.HtmlHelper_.addClass_(_this.mainElement_, TheDatepicker.ClassNameType.MainDarkMode, _this.options_);
                }
            };
            if (this.isVisible_ !== isVisible && this.options_.isFoldingAnimationEnabled() && this.options_.isHiddenOnBlur()) {
                TheDatepicker.Helper_.animate_(this.mainElement_, isVisible ? TheDatepicker.ClassNameType.AnimateExpand : TheDatepicker.ClassNameType.AnimateCollapse, this.options_, isVisible ? update : null, isVisible ? null : update);
            }
            else {
                TheDatepicker.Helper_.afterAnimate_(this.mainElement_, update);
            }
        ...
        Template_.prototype.slideTable_ = function (moveDirection, onComplete) {
            ...
            TheDatepicker.Helper_.animate_(this.tablesElement_, animationOut, this.options_, null, onComplete);
            TheDatepicker.Helper_.animate_(this.tablesElement_, animationIn, this.options_);
        };
