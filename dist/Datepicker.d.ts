...
export declare type HTMLDatepickerElement = (HTMLDatepickerInputElement & HTMLElement) | HTMLDatepickerContainerElement;
export declare type ReadyListener = (datepicker: Datepicker, element: HTMLDatepickerElement) => void;
export declare type ReadyPromiseResolve = (datepicker: Datepicker) => void;
