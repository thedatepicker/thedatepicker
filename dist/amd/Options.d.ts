...
export declare type SelectListener = (event: Event | null, day: Day | null, previousDay: Day | null) => boolean;
export declare type OpenOrCloseListener = (event: Event | null) => boolean;
export declare type MonthChangeListener = (event: Event | null, month: Date, previousMonth: Date) => boolean;
export declare type FocusListener = (event: Event | null, day: Day | null, previousDay: Day | null) => boolean;
declare type ListenerCaller = (listener: (event: Event | null, ...props: any) => boolean) => boolean;
export declare type DateAvailabilityResolver = (date: Date) => boolean;
export declare type CellContentResolver = (day: Day) => string;
export declare type StructureResolverInit = () => HTMLElement;
export declare type CellContentStructureResolverUpdate = (element: HTMLElement, day: Day) => void;
export interface CellContentStructureResolver {
    init: StructureResolverInit;
    update: CellContentStructureResolverUpdate;
}
export declare type CellClassesResolver = (day: Day) => string[];
export declare type DayModifier = (day: Day) => void;
